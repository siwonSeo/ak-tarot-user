...
import com.tarot.dto.response.ResponseTarotCardConsultTotal;
...
//        model.addAttribute("cards", tarotService.getTarotCards());
    ...
    public String auto(Model model,
        ...
        ResponseTarotCardConsultTotal responseTarotCardConsultTotal = tarotService.getTaroCardConsultsByRandom(cardCount, isReverseOn, categoryCode);

        model.addAttribute("consultId", responseTarotCardConsultTotal.consultId());
        model.addAttribute("cards", responseTarotCardConsultTotal.responseTarotCardConsults());
        return "selected";
    }
         ...
         @RequestParam("searchCards") String searchCards)
    {
        ...
        ResponseTarotCardConsultTotal responseTarotCardConsultTotal = tarotService.getTaroCardConsultsBySelf(cardCount,isReverseOn,categoryCode,cards);
